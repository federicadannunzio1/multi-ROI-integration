...
SAMPLES <- list(
  ...
  list(
    patient_id = "SHH_25-6667",
    group      = "SHH",
    rois       = list(
      ROI1 = file.path(DATA_DIR, "SHH_25-6667", "ROI1")
    )
  )
)
...
# Clustering
CLUSTERING_RESOLUTIONS <- c(0.1, 0.2, 0.3, 0.5)  # scansione; scegliere con clustree
FINAL_RESOLUTION       <- 0.1                       # aggiornare dopo ispezione clustree
...
PALETTE_GROUP <- c(G3 = "#E41A1C", SHH = "#377EB8")
